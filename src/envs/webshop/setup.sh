...
# Because I install rllm first, it has numpy==2.2.6
# So we need to uninstall conda numpy and reinstall compatible versions
conda uninstall -y numpy scipy pandas scikit-learn
pip install --force-reinstall numpy==1.22.4 pandas==1.4.2 scikit-learn==1.1.1
pip install faiss-cpu==1.7.2 # install faiss-cpu version compatible with numpy 1.22.4
