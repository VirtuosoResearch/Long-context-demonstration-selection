...
Description:
Finish the task by submitting your final answer.
...
You are being told a million times, each response must include a function call. Must include a function call at all costs.
